...
function Home() {
    ...
    const projects = [{url:'https://youtu.be/nE8qP0K1IhE', img:LocalHospital, title:'IDEL Stock',description:'Une application mobile de gestion d\'inventaire conçu pour un cabinet d\'infirmière libérales', link:'Voir le projet sur Youtube', stack:[react,firebase]},{url:'https://youtu.be/05ObRLxx9Pw', img:LibraryMusicIcon, title:'MusiQuiz', description:'Une application web de Quiz Musical conçu pour un musicien professionel', link:'Voir le projet sur Youtube', stack:[js,react,django,postgre]},{url:'', img:LibraryMusicIcon, title:'Loungetime', description:'Site web de présentation du groupe de musique Loungetime & Mrs Robinson', link:'Voir le projet sur Youtube', stack:[react,django]},{url:'https://youtu.be/X1uOWoI3A9Q', img:SailingIcon, title:'Yachting Conseil', description:'Reproduction d\'un site web de vente de bateau avec NextJS et Material UI', link:'Voir le projet sur Youtube', stack:[react,nextjs,mui]}]
